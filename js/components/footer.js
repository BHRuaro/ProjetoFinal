    ...
    <div class="row mt-3">
      ...
      <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
        ...
        <p>
          ...
          oferta.
          Não nos responsabilizamos por compras realizadas em sites de terceiros.
        </p>
      </div>
      <!-- Grid column -->
      ...
      <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
        ...
        <p>
          <a href="index.html" class="text-reset">Início</a>
        </p>
        <p>
      ...
      <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
        ...
        <p>
          <a href="#!" class="text-reset">Termos de Serviço</a>
        </p>
        <p>
          <a href="#!" class="text-reset">Políticas de Entrega</a>
        </p>
        <p>
          <a href="#!" class="text-reset">Políticas de Troca</a>
        </p>
        <p>
          <a href="#!" class="text-reset">Políticas de Privacidade</a>
        </p>
        <p>
          <a href="#!" class="text-reset">Políticas de Reembolso</a>
        </p>
      </div>
      <!-- Grid column -->
...
<div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.025);">
  <p>CNPJ: 11.222.333/0001-00</p>
  © 2023 Copyright
  <a class="text-reset fw-bold" href="#">Loja Nexus</a>
</div>
<!-- Copyright -->
</footer>`;